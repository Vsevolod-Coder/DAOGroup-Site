            ...
            <div className="contacts-cards">
              <div className="email-card card">
                ...
                <div
                  ...
                  onMouseLeave={() => hideCard("email")}
                  style={{
                    visibility: visibleCard === "email" ? "visible" : "hidden",
                  }}
                >
              ...
              <div className="phone-card card">
                ...
                <div
                  ...
                  onMouseLeave={() => hideCard("phone")}
                  style={{
                    visibility: visibleCard === "phone" ? "visible" : "hidden",
                  }}
                >
              ...
              <div className="schedule-card card">
                ...
                <div
                  ...
                  style={{
                    visibility:
                      visibleCard === "schedule" ? "visible" : "hidden",
                  }}
                >
              ...
              <div className="employee-card card">
                ...
                <div
                  ...
                  style={{
                    visibility:
                      visibleCard === "employee" ? "visible" : "hidden",
                  }}
                >
                  <p className="employee-text">
                    Контакты наших{" "}
                    <Link className="employee-page">сотрудников</Link>
                  </p>
                </div>
              </div>
            </div>
